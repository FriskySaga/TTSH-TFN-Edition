...
SellbotFieldOfficeMenu = [(OTPLocalizer.SellbotFieldOfficeMenuSections[0], xrange(30404, 30409)), (OTPLocalizer.SellbotFieldOfficeMenuSections[1], xrange(30409, 30419))]
